...
const createaccount = () => {
  ...
  return (
    <div className="w-96 h-90 rounded-3xl flex flex-col bg-white text-black mx-auto mt-72">
      <div
        className="bg-green-200 w-36 h-36 rounded-2xl text-3xl text-center px-7 py-11 mx-3"
        onClick={signinto}
      >
        SignIn
      </div>
      ...
      <div
        className="bg-sky-200 w-36 h-36 rounded-2xl text-3xl text-center mx-56 px-7 py-11"
        onClick={signupto}
      >
        SignUp
      </div>
