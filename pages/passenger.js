...
<form>
<div className='w-4/12 border bg-white rounded-lg py-5 m-auto my-80 px-4'>
  ...
  <button type="submit" class="text-white bg-blue-700 items-center  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"  onClick={travellerdetail}>Submit</button>
</div>
</form>
