...
const Handpick = () => {
  return (
    ...
    //   <div class="max-w-lg  rounded overflow-hidden m-4 sm:flex bg-white shadow-2xl  ">
    //     <div
    //       class="h-48 sm:h-auto sm:w-48 md:w-64 flex-none bg-cover bg-center rounded rounded-t sm:rounded sm:rounded-l text-center overflow-hidden bg-hero-pattern"
...
<div class="p-4 w-full text-center bg-white rounded-lg border  sm:p-8 dark:bg-white dark:border-white   ">
    <h5 class="mb-2 text-3xl font-bold text-gray-800 dark:text-gray-800">Download App Now !</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move work forward with Make My Trip on iOS &amp; Android. Download the app today.</p>
