...
import Download from "./Cards.js/Download";
import Offers from "./Cards.js/Offers";
import Tabs from "./Cards.js/Tabs";
import Footer from "./Cards.js/Footer";
  ...
  const data = [
    {
      ...
      title:
        "for your festive & year-end trips with our Travel Tyohaar - Diwali Edition!",
    },
    {
